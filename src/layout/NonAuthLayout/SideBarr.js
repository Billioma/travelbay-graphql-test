...
const SideBarr = () => {
  ...
  return (
    <div className="w-[50%] bg-[#F7F7F8] pt-[30px]">
      <div className="">
        <img src={logo} alt="logo" className="px-[57px]" />

        <div className="flex flex-col items-center justify-center">
          <div className="mt-[70px] bg-gradient-to-b from-white to-[#F7F7F8] rounded-[8px] px-[24px] py-[30px]">
            ...
            <div className="flex gap-[15px] w-full items-center">
              {btn.map((data, index) => (
                <div key={data.id} className="mb-[16px]">
          ...
          <div className="flex mb-[60px] flex-col justify-center items-center">
            ...
            <div className="mt-[4px] text-[15px] text-[#475467] text-center">
              ...
              <br /> for you. Tailor your perfect adventure with our custom trip{" "}
              <br />
              creation tool.
            </div>
